...
<body>
  ...
  <p>The table class adds basic styling (light padding and only horizontal dividers) to a table:</p> -->
			...
			<tr>
				...
				<td>Last Seen:</td>
				<td>From</td>
				<td><input type="text" name="lsfrom" id="lspickerfrom"
					placeholder="yyyy/mm/dd" class="form-control"></td>
				<td>To</td>
				<td><input type="text" name="lsto" id="lspickerto"
					placeholder="yyyy/mm/dd" class="form-control"></td>
			</tr>
			<tr>
				<td>Age-Range:</td>
				...
				<td id="total"></td>
				<td></td>
				<td><input type="checkbox" value="unsubscribe" class="form-control" name="unsubscribe"></td>
				<td>Unsubscribe table include</td>
			</tr>
			<tr>
	...
	<script>
		$(function () {
			$("#datepickerfrom, #datepickerto, #lspickerfrom, #lspickerto").datepicker({
				autoclose : true,
				changeYear : true,
				yearRange : '2015:2050',
				maxDate : '0d',
		...
		function dataFunction() {
			...
			var lsfrom = $('input[name="lsfrom"]').val();
			var lsto = $('input[name="lsto"]').val();
			...
			var unsubscribe=$('input:checkbox[name="unsubscribe"]:checked').val();
